...
import { normalizeFashionTypos, dropGenericWhenSpecific, buildMandatoryConcepts, classifyQuerySlot, productMatchesSlot, productMatchesGarmentKey, decomposeQuery, GARMENT_VOCAB, GARMENT_CATEGORY, type SlotCategory } from '@/lib/queryParser'
...
import {
  cleanSubQuery, garmentLabel, separatedGarmentKeys, outfitSlotInfo,
